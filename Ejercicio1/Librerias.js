...
function gestionarFicheroXML(xmlDoc){
	...
	capaVacia.outerHTML += "<div id = \"Tabla\">";
	for (let i = 1; i <= libreria.length; i++) {
		capaVacia.outerHTML += "<div id= \"Libreria\">"+nombre[i-1].textContent+"</div><div class=\"fila\"> <div class=\"celda\">ISBN</div> <div class=\"celda\">titulo</div> <div class=\"celda\">Nivel de profundidad</div> <div class=\"celda\">autor</div> <div class=\"celda\">editorial</div> <div class=\"celda\">fecha de publicacion</div> <div class=\"celda\">pagina Web</div ><div class=\"celda\">precio</div></div><div class=\"fila\">";

		for(let j=1; j<=3; j++){
		capaVacia.outerHTML = capaVacia.outerHTML + "<div class=\"celda\">" + libros[(i*j)-1].textContent + "</div>";
		}
		capaVacia.outerHTML +="</div>";
	}
	capaVacia.outerHTML += "</div>";
